...
const works = [
    ...
    {
        title: 'Life By IFG',
        description: 'An insurance app designed to provide policyholders with essential information about their life insurance policies.',
        year : '2022 - 2023',
        image : ifg,
        tags: ['web', 'rest', 'quarkus']
    },
    {
        title: 'Fooma',
        description: 'Lifestyle apps seamlessly integrates food discovery, culinary experiences, and event management.',
        year : '2023',
        image : fooma,
    ...
    {
        title: 'Fooma CRM',
        description: 'CRM system seamlessly integrates guest data, personalized marketing, and operational efficiency for restaurants and hospitality businesses.',
        year : '2023',
        image : foomaCrm,
        tags: ['web', 'rest', 'quarkus']
    },
