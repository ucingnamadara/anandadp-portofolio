...
const experiences = [
    {
        ...
        description : "I develop a back-end systems for banking applications, adept at delivering secure and robust software solutions that streamline banking operations and enhance user experiences.",
